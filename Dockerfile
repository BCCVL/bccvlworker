...
RUN pip2.7 install -r requirements.txt && \
    pip2.7 install -f https://github.com/BCCVL/org.bccvl.movelib/archive/1.2.0.tar.gz#egg=org.bccvl.movelib-1.2.0 org.bccvl.movelib[http,scp,swift]==1.1.0 && \
    pip2.7 install -f https://github.com/BCCVL/org.bccvl.tasks/archive/1.11.0.tar.gz#egg=org.bccvl.tasks-1.11.0 org.bccvl.tasks[metadata]==1.10.0
